...
{
    // Source: http://answers.unity.com/answers/1156088/view.html
    public static class ExtDebug
    {
        public const float DEFAULT_DURATION = 2f;

        //Draws just the box at where it is currently hitting.
        public static void DrawBoxCastOnHit(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Vector3 direction, float hitInfoDistance, Color color, float duration = DEFAULT_DURATION)
        {
        ...
        public static void DrawBoxCastBox(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Vector3 direction, float distance, Color color, float duration = DEFAULT_DURATION)
        {
            direction.Normalize();
        ...
        public static void DrawBox(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Color color, float duration = DEFAULT_DURATION)
        {
            DrawBox(new Box(origin, halfExtents, orientation), color, duration);
        }
        public static void DrawBox(Box box, Color color, float duration = DEFAULT_DURATION)
        {
